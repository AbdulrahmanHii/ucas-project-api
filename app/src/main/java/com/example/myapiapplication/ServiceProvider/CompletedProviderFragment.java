 ...
 * Use the {@link CompletedProviderFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class CompletedProviderFragment extends Fragment {
    ...
    public CompletedProviderFragment() {
    ...
    public static CompletedProviderFragment newInstance(String param1, String param2) {
        CompletedProviderFragment fragment = new CompletedProviderFragment();
...
//        String  date = dateFormat.format(calendar.getTime());
        ...
        StringRequest requestGetData = new StringRequest(GET, "https://studentucas.awamr.com/api/order/complete/delivery", new Response.Listener<String>() {
            @Override
