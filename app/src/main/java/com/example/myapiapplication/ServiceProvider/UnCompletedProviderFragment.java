 ...
 * Use the {@link UnCompletedProviderFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UnCompletedProviderFragment extends Fragment {
    ...
    public UnCompletedProviderFragment() {
    ...
    public static UnCompletedProviderFragment newInstance(String param1, String param2) {
        UnCompletedProviderFragment fragment = new UnCompletedProviderFragment();
...
//        String  date = dateFormat.format(calendar.getTime());
        ...
        StringRequest requestGetData = new StringRequest(GET, "https://studentucas.awamr.com/api/order/un/complete/delivery", new Response.Listener<String>() {
            @Override
...
//                        ArrayList<>= jObject.getString("data");



//                        Log.e("myData", "myData" + OrderNum + date);



//                        arrayListPending.add(new PendingClass(OrderNum,serviceType,date));
//                        adapter = new PendingAdapterRecycler(arrayListPending);
//
//                        binding.recyclerViewPending.setAdapter(adapter);
//                        binding.recyclerViewPending.setLayoutManager(new LinearLayoutManager(getActivity(),
