 ...
 * Use the {@link UnCompleteCustomerFrg#newInstance} factory method to
 * create an instance of this fragment.
 */
public class UnCompleteCustomerFrg extends Fragment {
    ...
    public static UnCompleteCustomerFrg newInstance(String param1, String param2) {
        UnCompleteCustomerFrg fragment = new UnCompleteCustomerFrg();
...
//  TODO:  arrayListPending.add(new PendingClass(OrderNum,serviceType,date));
    ...
    void ReadAllData() {
        ...
        StringRequest requestGetData = new StringRequest(GET, "https://studentucas.awamr.com/api/order/un/complete/user", new Response.Listener<String>() {
            @Override
